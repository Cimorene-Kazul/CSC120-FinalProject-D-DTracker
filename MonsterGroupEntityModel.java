public class MonsterGroupEntityModel extends MonsterEntityModel{
    int size;
    Integer individualHP;
    String baseName;
    
    public MonsterGroupEntityModel(String fileName, int number, String locationNotes){
        this(fileName, number);
        this.locationNotes = locationNotes;
    }

    public MonsterGroupEntityModel(String fileName, int number){
        super(fileName);
        this.size = number;
        this.HPmax *= number;
        this.HP = this.HPmax;
        this.individualHP = this.HPmax/number;
